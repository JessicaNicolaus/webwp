                    Bitnami WordPress Stack 5.3.2-2
                  ==============================
...
bitnami-wordpress-5.3.2-2-linux-x64-installer.run on Linux 64 bit or
bitnami-wordpress-5.3.2-2-windows-installer.exe on Windows or
bitnami-wordpress-5.3.2-2-osx-x64-installer.dmg on OS X.
...
in /home/user/wordpress-5.3.2-2 on Linux or
C:\Bitnami\wordpress-5.3.2-2 on Windows or
/Applications/wordpress-5.3.2-2 on OS X and that you use port 8080
...
/home/user/wordpress-5.3.2-2/apache2/logs/error.log on Linux or
C:\bitnami\wordpress-5.3.2-2\apache2\logs\error.log on Windows or
/Applications/wordpress-5.3.2-2/apache2/logs/error.log.
